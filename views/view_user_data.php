    ...
    <div class="row">
        ...
        <div class="col-md-4">            
            <div class="card my-3">
                ...
                <div class="card-body">
                    <?php echo '<a href="?convert=pdf&user-id='.$id_usuario.'" class="btn btn-danger w-100 mb-3">Convertir en PDF <i class="far fa-file-pdf"></i></a>'; //BOTON PARA CONVERTIR EN PDF?>
