    ...
    if($_SESSION['usuario-online'][6] < 3000){ //SE COMPRUEBA QUE EL USUARIO TENGA MENOS DE 3000 EN LA CUENTA
        ...
        if($_SESSION['usuario-online'][7] > 0){ // SE COMPRUEBA QUE EL USUARIO TENGA UNA DEUDA
            ...
            if($deuda_reducida > 0){ // SI EL USUARIO NO PUDO PAGAR SU DEUDA ENTONCES ENTONCES DEBE ACTUALIZARSE LO QUE LE FALTA POR PAGAR
                ...
                mysqli_query($connect_db, "INSERT INTO recargas (ID_Usuario, Monto_Recargado, Pago_Deuda) VALUES ('$id_usuario', '$monto_recargar', '$monto_recargar')");
                ...
                mysqli_query($connect_db, "INSERT INTO recargas (ID_Usuario, Monto_Recargado, Pago_Deuda) VALUES ('$id_usuario', '$monto_recargar', '$deuda')");
            ...
            mysqli_query($connect_db, "INSERT INTO recargas (ID_Usuario, Monto_Recargado, Pago_Deuda) VALUES ('$id_usuario', '$monto_recargar', '0')");
